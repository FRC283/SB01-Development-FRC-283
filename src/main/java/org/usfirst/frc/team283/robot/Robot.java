...
public class Robot extends IterativeRobot 
{
	...
	int buttonNum;//Button pushed on Controller
	Joystick logitech, xbox, extra;
	Compressor largeComp, smallComp;
	...
	public void robotInit() 
	{
		...
		largeComp = new Compressor(0);
		smallComp = new Compressor(1);
	...
	{
		//driveSubsystem.drive(extra.getRawAxis(0), extra.getRawAxis(1), 
		//					 extra.getRawAxis(3),
		//					(extra.getRawButton(1) || logitech.getRawButton(Constants.START)));
		driveSubsystem.drive(logitech.getRawAxis(Constants.LEFT_Y), logitech.getRawAxis(Constants.RIGHT_Y), 
				logitech.getRawAxis(Constants.LEFT_X), logitech.getRawAxis(Constants.RIGHT_X), (logitech.getRawButton(Constants.LEFT_STICK_BUTTON) || logitech.getRawButton(Constants.RIGHT_STICK_BUTTON)));
